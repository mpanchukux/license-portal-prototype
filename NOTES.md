...
`shared.js` → `Store`. Один ключ **`tb-license-portal-demo-v2`**. ⚠️ **Ключ версійований,
...
ключ просто лишається лежати. (v1 → v2 зроблено саме тому: варіанти мітки й дефолтний
large account не доїхали до вже наявних сторів.)
